...
package com.ihsinformatics.is3web.server.util;
...
public class ReportUtil
{
	...
	try
	{
	    ...
	    String dest = com.ihsinformatics.is3web.shared.IRZ.getResourcesPath() + String.valueOf(new Date().getTime()) + ".csv";
	...
	try
	{
	 ...
	 //   getResourcesPath ();
	    System.out.println(IRZ.getReportPath());
	    String filePath = IRZ.getReportPath()  + fileName + (fileName.endsWith(".jrxml") ? "":".jrxml");
	    System.out.println(filePath);
	    JasperReport jasperReport = JasperCompileManager.compileReport(filePath);
//	    JasperReport jasperSubReport = JasperCompileManag er.compileReport(subReportSource);
//
...
//	    parameters.put("subreportParameter", jasperSubReport);
    ...
    public static String generateReportWithSubreport(String fileName,String[] subReports , Parameter[] params, boolean export)
    {
    	try
    	{
    	    Connection con = HibernateUtil.util.getSession().connection();
    	 ...
    	 //   getResourcesPath ();
    		 ...
    		 */
    	//	map.put(params[i].getName(), toObject(params[i]));
    		JasperReport jasperSubReport = JasperCompileManager.compileReport(IRZ.getReportPath() +params[i].getName()+".jrxml");
    	    
    		map.put(params[i].getName(), jasperSubReport);
